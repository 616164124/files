...
2. 根可达算法(RootSearching) （以下可以作为GC Root的对象）
...
5. ![1603644728025](assets/1603644728025.png)

   过程 视频 https://www.bilibili.com/video/BV1AZ4y147fD?p=2

   ![1603648256669](assets/1603648256669.png)
...
#### 5.常见的垃圾回收器
 ...
 ![img](assets/20190331203408467.png) 
...
### JVM调优第一步，了解JVM常用命令行参数(java -XX:+PrintFlagsFinal -version  查看jvm的信息  )
...
2. 生产环境中，倾向于将最大堆内存和最小堆内存设置为：（为什么？） 相同
   A: 相同 B：不同
